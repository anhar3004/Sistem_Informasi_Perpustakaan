                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <a href="transaksi/add" class="btn btn-primary"><i class="fa fa-plus"></i>
...
let dtList = new Tabulator("#dt-list", {
    ...
    ajaxURL: window.location.origin + "/transaksi/lists",
    ajaxConfig: "POST",
    sortMode: "remote",
    filterMode: "remote",
...
function hapus(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            console.log(id)
            $.ajax({
                url: window.location.origin + "/transaksi/delete/" + id,
                type: 'GET',
...
Swal.fire({
    title: 'Apakah kamu yakin ingin merubah status data transaksi ini?',
    icon: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#3085d6',
    cancelButtonColor: '#d33',
    ...
    if (result.isConfirmed) {
        $.ajax({
            url: window.location.origin + "/transaksi/update-status/" + id + "/" +status,
            type: 'GET',
            success: function(data) {
                Swal.fire(
                    'Update!',
